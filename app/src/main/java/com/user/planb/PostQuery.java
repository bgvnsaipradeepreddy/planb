...
public class PostQuery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.tbIncludePostQuery);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowHomeEnabled(true);
        etpostdetails = (EditText)findViewById(R.id.etEventPostQuery);
        etTitle = (EditText) findViewById(R.id.etTitlePostQuery);
        ibattachimage=(ImageButton)findViewById(R.id.ibImagePostQuery);
        ibhyperlink = (ImageButton) findViewById(R.id.ibHyperlinkPostQuery);
        boldButton = (ImageButton) findViewById(R.id.ibBoldPostQuery);
        italicButton= (ImageButton) findViewById(R.id.ibItalicPostQuery);
        underlineButton = (ImageButton) findViewById(R.id.ibUnderlinePostQuery);
        focusText = (LinearLayout)findViewById(R.id.llPostQuery);
        buttonVisible = (LinearLayout)findViewById(R.id.trPostQuery);
        progressBar = (ProgressBar) findViewById(R.id.pbPostQuery);
        ...
        ibattachimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(PostQuery.this);
        ...
        bToolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SessionManagement sessionManagement = new SessionManagement(PostQuery.this);
                ...
                if (title.equals("")) {
                    Toast.makeText(PostQuery.this, "Query is empty. Please add Query", Toast.LENGTH_LONG).show();
                } else {
                    if (checkConnection()) {
                        try {
                            RequestPackage requestPackage = new RequestPackage();
                            requestPackage.setMethod("POST");
                            requestPackage.setUri(getResources().getString(R.string.server) + "insertQueries");
                            requestPackage.setParam("userId", userId);
                            requestPackage.setParam("queryTitle", title);
                            requestPackage.setParam("queryDescription", description);
                            requestPackage.setParam("placeId", placeId);
                            PostQuery.AddQuery addQuery = new PostQuery.AddQuery();
                            addQuery.execute(requestPackage);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    } else {
                        Toast.makeText(PostQuery.this, "No Internet connect. Please connect and try again", Toast.LENGTH_LONG).show();
                    }
                }
    ...
    private class AddQuery extends AsyncTask<RequestPackage,String,String> {
        ...
        protected void onPostExecute(String content) {
            ...
            if(http_output == null){
                ...
                Toast.makeText(PostQuery.this, "Maintainence activity is in progress. Please try after sometime", Toast.LENGTH_LONG).show();
            }else {
                try {
                ...
                if (dataItems.getQueryStatus().equals("successful")) {
                    ...
                    DataSource source = new DataSource(PostQuery.this);
                    progressBar.setVisibility(View.INVISIBLE);
                    setResult(Activity.RESULT_OK);
                    finish();
                    Toast.makeText(PostQuery.this, "Your query has been succesfully posted. " , Toast.LENGTH_LONG).show();
                } else {
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(PostQuery.this, "Cannot Post. Try after sometime. "
