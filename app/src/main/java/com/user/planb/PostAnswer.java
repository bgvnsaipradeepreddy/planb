...
public class PostAnswer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query_id = bundle.getInt("queryId");
        ...
        ibattachimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(PostAnswer.this);
        ...
        bToolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                SessionManagement sessionManagement = new SessionManagement(PostAnswer.this);
                ...
                if (description.equals("")) {
                    Toast.makeText(PostAnswer.this, "Answer is empty. Please add Answer", Toast.LENGTH_LONG).show();
                } else {
                    if (checkConnection()) {
                        try {
                            RequestPackage requestPackage = new RequestPackage();
                            requestPackage.setMethod("POST");
                            requestPackage.setUri(getResources().getString(R.string.server) + "answerQueries");
                            requestPackage.setParam("userId", userId);
                            requestPackage.setParam("queryAnswer", description);
                            requestPackage.setParam("queryId", queryId);
                            PostAnswer.AddAnswer addAnswer = new PostAnswer.AddAnswer();
                            addAnswer.execute(requestPackage);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    } else {
                        Toast.makeText(PostAnswer.this, "No Internet connect. Please connect and try again", Toast.LENGTH_LONG).show();
                    }
                }
            }
        });
    ...
    private class AddAnswer extends AsyncTask<RequestPackage,String,String> {
        ...
        protected void onPostExecute(String content) {
            ...
            if(http_output == null){
                ...
                Toast.makeText(PostAnswer.this, "Maintainence activity is in progress. Please try after sometime", Toast.LENGTH_LONG).show();
            }else {
                try {
                ...
                if (dataItems.getQueryStatus().equals("successful")) {
                    ...
                    DataSource source = new DataSource(PostAnswer.this);
                    progressBar.setVisibility(View.INVISIBLE);
                    setResult(Activity.RESULT_OK);
                    finish();
                    Toast.makeText(PostAnswer.this, "Your query has been succesfully posted. " , Toast.LENGTH_LONG).show();
                } else {
                    progressBar.setVisibility(View.INVISIBLE);
                    Toast.makeText(PostAnswer.this, "Cannot Post. Try after sometime. "
